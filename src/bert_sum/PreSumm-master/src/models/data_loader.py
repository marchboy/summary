...
def load_dataset(args, corpus_type, shuffle):
    ...
    if corpus_type == "train":
        pts = sorted(
            [
                "../bert_data/train.0.bert.pt",
                "../bert_data/train.1.bert.pt",
                "../bert_data/train.2.bert.pt",
                "../bert_data/train.3.bert.pt",
                "../bert_data/train.4.bert.pt",
            ]
        )
    else:
        pts = sorted(["../bert_data/val.5.bert.pt"])
    if pts:
        if shuffle:
            random.shuffle(pts)
